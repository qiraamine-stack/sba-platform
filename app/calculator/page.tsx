...
export default function CalculatorPage() {
  ...
  const exportPDF = async () => {
    ...
    doc.text(`Sellers Discretionary Earnings (SDE): ${fmt(results.val.sde)}`, 20, 58);
    ...
    doc.text("This report is for informational purposes only.", 20, 270);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="bg-white rounded-xl shadow p-6">
            ...
            {[
              ...
              { label: "Owners Salary", name: "owners_salary" },
              { label: "Owners Benefits", name: "owners_benefits" },
        ...
        {results && (
          <div>
            <button onClick={exportPDF}
              className="w-full mb-6 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 rounded-xl transition">
              Download PDF Report
            </button>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl shadow p-6">
                <h2 className="text-lg font-semibold mb-4 text-gray-800">Business Valuation</h2>
                <p className="text-sm text-gray-500 mb-1">Sellers Discretionary Earnings (SDE)</p>
                ...
                <p className="text-xs text-gray-400 mt-3">Multiple: {results.val.valuation.multiple_used}x</p>
              </div>
              <div className="bg-white rounded-xl shadow p-6">
